ipt_file = open("input5_4.txt", 'r')
opt_file = open("output5_4.txt", 'w')

v, e, dest = list(map(int, ipt_file.readline().strip().split()))
...
print(f"Time : {level[dest]}", file=opt_file)
...
answer.reverse()
print("Shortest Path: ", end="", file=opt_file)
for x in answer:
    print(x, end = " ", file=opt_file)
